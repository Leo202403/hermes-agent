---
name: excel-author
description: Build auditable Excel workbooks with openpyxl.
version: 1.0.0
...
metadata:
  hermes:
    ...
    related_skills: [pptx-author, dcf-model, comps-analysis, lbo-model, 3-statement-model, institutional-research]
---
...
Pair with `institutional-research` whenever workbook inputs come from current,
external, financial, regulatory, market, or diligence sources.
