---
name: comps-analysis
description: Build comparable-company analysis workbooks.
version: 1.0.0
...
metadata:
  hermes:
    ...
    related_skills: [excel-author, pptx-author, dcf-model, lbo-model, institutional-research]
---
...
Use `institutional-research` for source hierarchy, freshness checks, evidence
matrix construction, and final citation review before any model output.
